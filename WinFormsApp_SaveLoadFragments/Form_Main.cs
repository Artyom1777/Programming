...
namespace WinFormsApp_SaveLoadFragments
{
    public partial class Form_Main : Form
    {
        ...
        InitializeComponent();
            ...
            Bitmap bmp_pic = new Bitmap(im_pic);//bmp_pic = ; 
            Size size_pic = new Size(pictureBox.Width, pictureBox.Height);
            arr_pictures = new ArrayPictures(pictureBox, bmp_pic, size_pic, 3, 4); // инициализируем фрагменты
            AssignPictures(); // назначить клики для фрагментов и выполняем прорисовку 
        }
